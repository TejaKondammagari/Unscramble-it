...
public class GameInfo {
    ...
    private boolean[] validCategory; //array tracks if the category is valid for player to choose from
    ...
    GameInfo(int playerNum){
        ...
        validCategory = new boolean[] {true, true, true}; //defaults to true
    ...
    public void setValidCategory(int i){ validCategory[i] = !validCategory[i]; }

    //gets the validity of the category of a given index
    public boolean getValidCategory(int i ) { return validCategory[i]; }
